          ...
          <div class="container">
            <div class="carousel-caption">
			  ...
			  <p>Entdecke, was in deinem Verein gerade los ist.</p>
                    ...
                    <p><a class="btn btn-m btn-primary btn-block rount" href="vereinregistrieren" role="button">Verein Registrieren</a></p>
                    <p><a class="btn btn-m btn-primary btn-block rount" href="mitgliedregistrieren" role="button">Mitglied Registrieren</a></p>    
                </div>
          </div>
        </div>
